...
import { ChainId, JSBI, Percent, Token, CurrencyAmount, Currency } from '@snowswap/sdk'
import { ROUTER_ADDRESS } from '../config/constants'
import { BASE_BSC_SCAN_URLS, ETHER } from '../config'
...
export function getBscScanLink(
  ...
  chainId: ChainId = process.env.REACT_APP_CHAIN_ID as unknown as ChainId,
): string {
  switch (type) {
    case 'transaction': {
