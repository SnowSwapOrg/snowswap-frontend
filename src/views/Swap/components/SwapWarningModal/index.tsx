...
import { ModalBody, ModalContainer, Message, ModalHeader, Box, Heading } from '@snowswap/uikit'
...
const SwapWarningModal: React.FC<SwapWarningModalProps> = ({ swapCurrency, onDismiss }) => {
  ...
  const TOKEN_WARNINGS = {
    // [SwapWarningTokensConfig.ring.address]: {
    //   symbol: SwapWarningTokensConfig.ring.symbol,
